            ...
            <List>
                <ListItem>
                    <Link href='https://github.com/kwame-Owusu' target="_blank">
                        <Button variant="ghost" color={"#99d199"} leftIcon={<Icon as={IoLogoGithub} />} >
                            @Kwame-Owusu
                        </Button>
                    </Link>
                ...
                <ListItem>
                    <Link href='https://www.instagram.com/ghanianpapi/' target="_blank">
                        <Button variant="ghost" color={"#99d199"} leftIcon={<Icon as={IoLogoInstagram} />} >
                            @Kwame-Owusu
                        </Button>
                    </Link>
                ...
                <ListItem>
                    <Link href='https://www.linkedin.com/in/alfredow23/' target="_blank">
                        <Button variant="ghost" color={"#99d199"} leftIcon={<Icon as={IoLogoLinkedin} />} >
                            @Kwame-Owusu
                        </Button>
                    </Link>
                ...
                <ListItem>
                    <Link href='https://myanimelist.net/profile/Kwamee-owusu' target="_blank">
                        <Button variant="ghost" color={"#99d199"} >
                            @MAL
                        </Button>
                    </Link>
